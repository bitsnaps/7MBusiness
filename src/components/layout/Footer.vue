      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="text-xl font-bold">Coach 360</span>
          </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="#" class="text-gray-300 hover:text-blue-400 transition-colors">Individual Coaching</a></li>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-300 hover:text-blue-400 transition-colors">Terms of Service</a></li>
          </ul>
        </div>
      </div>
